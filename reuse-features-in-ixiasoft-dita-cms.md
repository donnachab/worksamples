...
Ixiasoft DITA CMS provides a suite of features designed to streamline this process.

Note

Examples provided on this page are based on a SupplyChain Solutions company, that manages supply chain operations for various clients and often needs to create variant documents.
...
For additional information on using Conrefs, refer to the Ixiasoft DITA CMS Conref Guide.
Read about the equivalent feature in MadCap Flare: Snippet.
Key References (Keyref)
...
For additional information on using Keyrefs, refer to the Ixiasoft DITA CMS Keyref Guide.
Read about the equivalent feature in MadCap Flare: Variable.
Conditional Processing (Profiling)
